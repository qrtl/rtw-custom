...
class MailThread(models.AbstractModel):
    ...
    def _notify_record_by_email(
        ...
        **kwargs
        ...
        template_xmlid = (
            email_layout_xmlid
            if email_layout_xmlid else "mail.message_notification_email"
        )
        try:
        ...
        for recipients_group_data in recipients_groups_data:
            ...
            if signature and signature_location == "b":
                ...
                if quote_index:
                    mail_body = (
                        mail_body[:quote_index] + signature.encode("utf-8") +
                    ...
                    if check_existing:
                        ...
                        if existing_notifications:
                            tocreate_recipient_ids = [
                                rid for rid in recipient_ids if rid not in
